...
_G.GRANK_TO = 2
_G.GZONE_TO = 400 -- ONLY increase above 99 to go to world2, only when 100% sure, there is no way back for the "best zone" quests etc. 
...
_G.GENCHANTS = {"Coins", "Treasure Hunter", "Strong Pets", "Criticals"}
