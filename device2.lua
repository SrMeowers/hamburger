...
getgenv().LoadSettings = [[{"Inventory":{"Fruits":{"Use":true,"Fruit":["Watermelon","Candycane","Apple","Rainbow","Pineapple","Orange","Banana"]},"Flags":{"Flag":"Coins Flag","Use":true},"UseTNT":false,"Potions":{"Level":9,"Potion":["Coins","Lucky","The Cocktail","Huge","Treasure Hunter","Damage"],"Use":true}},"Farming":{"Flags":{"Flag":"Shiny Flag","Use":false},"ZoneMovement":false,"UseTNT":false,"Zone":"0 - Best Unlocked","Start":true,"Ultimate":true,"MovementMode":"Teleporting","PetsPerBreakable":3},"UIScale":0.9,"Optimization":{"HatchAnim":true,"Teleports":true,"Drops":true,"Breakables":false,"SkipSpin":true,"Wheels":true,"Merchants":true,"PetSpeed":true,"Machines":true,"Items":true,"Scripts":true,"Confetti":true,"Pets":true,"Startup":{"Instance":"","autoJoin":false},"World":true},"Machines":{"Golden":false,"Rainbow":false,"Method":"All Available Pets","Fuse":false},"World":{"Instances":{"Millionaire":{"Run":true,"MaxPercent":80,"MaxRoom":20}},"AutoWorld":false,"CollectRelics":false,"BuyUpgrades":false},"LoadSettings":true,"Hatching":{"Egg":"0 - Best Unlocked","MailUser":"Enter your Username.","Webhook":"Enter your Webhook Url.","Amount":0,"Start":true,"HugeNotif":false,"MailStart":false}}]]
